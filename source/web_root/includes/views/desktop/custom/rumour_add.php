<?php
	...
	if ($step == 1) {
			...
			/* Description */	echo "  <div class='col-md-12'>" . $form->input('textarea', 'description', @$_POST['description'], true, 'Rumour|Please be as concise as possible', 'form-control richtext', null, 255, array('rows'=>'10')) . "</div>\n";
			echo "</div>\n";
			echo "<div class='row form-group'>\n";
