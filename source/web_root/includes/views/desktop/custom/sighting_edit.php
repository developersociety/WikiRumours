<?php
	...
	/* Country */			echo $form->row('country', 'country_id', $operators->firstTrue(@$_POST['country_id'], @$sighting[0]['sighting_country_id'], (@!$id && @$tl->page['domain_alias']['country_id'] ? $tl->page['domain_alias']['country_id'] : false)), true, 'Country where heard', 'form-control select2 form-select');
